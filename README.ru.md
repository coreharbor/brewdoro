...
Нажмите **«Сбросить»**, чтобы перезапустить текущий таймер. Если цикл Pomodoro уже идёт, на сброшенном таймере кнопка сменится на **«Сбросить сессию»** и позволит обнулить весь цикл.
...
Нашли ошибку, придумали полезное улучшение или хотите помочь с переводом? Прочитайте [инструкцию для участников](CONTRIBUTING.md), затем создайте issue или отправьте pull request.

...
- Настраиваемая длительность фокуса и перерывов в одном небольшом меню
- Пауза, продолжение и сброс
- Опциональный цикл из четырёх фокус-сессий с автоматической сменой этапов
- Восстановление сессии после закрытия приложения или сна компьютера
- Горячие клавиши: `Space`, `R` и `1` / `2` / `3`
